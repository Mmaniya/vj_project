                            ...
                            <div class="tabs-box">
                                <div class="tab-btn-box">
                                    <ul class="tab-btns tab-buttons clearfix">
                                        <li class="tab-btn active-btn" data-tab="#tab-4">Login</li>
                                    </ul>
                                </div>
                                <div class="tabs-content">
                                    <form action="javascript:void(0);" method="post" id="userAccountLogin">
                                        <input type="hidden" value="LoginAc" name="act">
                                        <div class="tab active-tab" id="tab-4">
                                            <div class="content-inner">
                                                <p>Enter Your Login Details</p>
                                                <div class="form-group">
                                                    <i class="fas fa-user"></i>
                                                    <input type="text" name="userid" placeholder="Your User Id" value="">
                                                </div>                                              
                                                <div class="form-group">
                                        ...
                                        <br>
                                        <h6>New Member<a href="myaccount.php"> Click Here.! </a></h6>
                                    </form>
                                </div>
                            </div>
                        </div>
